...
const notes = [
  {
    ...
    title: "React Hooks",
    tags: ["react", "frontend"],
    content: "useEffect dependencies and custom hooks",
  },
  {
    id: "roadmap",
    title: "Frontend Roadmap",
    tags: ["planning"],
    content: "Ship the React dashboard after accessibility review",
  },
  {
    id: "database",
    title: "MongoDB Notes",
    tags: ["backend"],
    content: "Indexes and query planning",
  },
  {
    id: "cooking",
    title: "Weekend Cooking",
    tags: ["personal"],
    content: "Roast vegetables and sourdough",
  },
  {
    id: "deleted-react",
    title: "Old React Draft",
    tags: ["react"],
    content: "Old hooks draft",
  ...
  },
  {
    ...
    title: "Web Security",
    tags: ["security"],
    content: "Cookies, authorization, and input validation",
  },
  {
    id: "travel",
    title: "Travel Ideas",
    tags: ["personal"],
    content: "Weekend train routes and city walks",
  },
];
...
const dataset = {
  ...
  queries: [
    ...
    {
      id: "tag-topic",
      question: "frontend planning",
      expectedIds: ["react", "roadmap"],
    },
    ...
    { id: "missing", question: "quantum physics", expectedIds: [] },
    {
      ...
      question: "How do I protect a web app?",
      expectedIds: ["security"],
    },
    {
      id: "conceptual",
      category: "conceptual",
      question: "prevent unauthorized access",
      expectedIds: ["security"],
    },
    {
      id: "multi-topic",
      category: "multi-topic",
      question: "React accessibility rollout",
      expectedIds: ["roadmap", "react"],
    },
    {
      id: "ambiguous",
      category: "ambiguous",
    ...
    },
    {
      ...
      question: "React dashboard accessibility",
      expectedIds: ["roadmap", "react"],
    },
  ],
};
...
test("retrieval evaluation reports deterministic baseline metrics", () => {
  ...
  assert.equal(
    report.results.find((result) => result.id === "exact-title").hit,
    true,
  );
  assert.equal(
    report.results.find((result) => result.id === "missing").hit,
    false,
  );
