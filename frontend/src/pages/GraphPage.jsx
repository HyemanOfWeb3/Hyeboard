        ...
        <main className="main-content graph-page">
            ...
            <div>
              ...
              <h2>
                {currentNote
                  ...
                  : "Your note relationships"}
              </h2>
              <p>
                {offlineIncomplete
                  ? "Offline view · showing locally available notes."
          ...
          {loading ? (
            <div className="graph-empty">
              <Network className="spin" size={24} />
              <span>Loading relationships...</span>
            </div>
          ) : (
            <NoteGraph
              graph={graph}
              currentNoteId={getNoteReference(currentNote)}
              navigate={navigate}
              scope={scope}
              setScope={setScope}
              depth={depth}
